...
imprimir_dos_digitos:
    ...
    mov bl, 10
    div bl              ; AH = AL mod 10, AL = AL / 10
    
    add al, '0'         ; Convertir primer dígito a ASCII
    mov dl, al
    mov ah, 02h
    int 21h
    
    mov al, ah          ; Mover segundo dígito a AL
